...
function homeView() {
  return `
    ...
    <section class="section weather-section">
      <div class="weather-heading"><div><span class="kicker">Før du tager afsted</span><h2>Vejr og sejladsforhold</h2></div></div>
      <div class="beginner-weather-guide"><div class="wind-range"><strong>4–8</strong><span>m/s</span></div><div><h3>Gode forhold for begyndere</h3><p>En vindstyrke på 4–8 m/s er normalt passende, når du skal lære at windsurfe. Pålandsvind kan skabe bølger og gøre det vanskeligere at komme ud fra stranden, så vurder altid bølgerne og spørg en instruktør før sejlads.</p><p class="offshore-warning"><strong>Livsfare:</strong> Sejl aldrig i fralandsvind uden følgebåd. Fralandsvind kan hurtigt føre dig væk fra kysten og gøre det umuligt at komme tilbage.</p></div></div>
